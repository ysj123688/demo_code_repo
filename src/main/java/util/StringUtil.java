...
//	}
	...
	public static boolean isNotEmptyAndWhitespace(String s) {
		s = makeSafe(s);
		if (s.length() > 0) {
			for (int i = 0, n = s.length(); i < n; i++) {
...
//	}
  ...
  */
	...
	*/
	 ...
	 * @return
	 */
	public static boolean containDigit(String checkString){
		for (char c : checkString.toCharArray()){
			Matcher m = DigitPattern.matcher(c+"");  
			if (m.matches()){
				return true;
			}
		}
	 ...
	 * @param splitString
	 */
	public static List<String> resolveDigitArray(String splitString){
        String regex = "\\d*";
	 ...
	 * @return
	 */
	public static String filterHTMLLanguage(String str){
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		String line = "κ����	���֤	350204195906154014					2014-07-04";
		String line2 = "你好";
		System.out.println(isMessyCode(line));
		System.out.println(isMessyCode(line2));
